...
const ClipTransform:FC<ClipTransformProps> = ({map, draw, activeFeatures, setLoading, handleSetErrorMessage, handleUpdateDrawnFeatures, stopRotation}) => {
	...
	const [clipFeatures, setClipFeatures] = useState<Feature[]>([]);
	...
	const handleUpload = async () => {
        ...
        try {
            ...
            if (response.status === 200) {
				const geojsonData = response.data;
				const responseClipFeatures: Feature[] = geojsonData.features;
